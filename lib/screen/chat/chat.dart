                  ...
                  GestureDetector(
                    onLongPress: () {
                      Clipboard.setData(ClipboardData(
                          text: "mnlkgtf kmnl;bj bpis; lkjnvi;olds  "));
                    ...
                    child: Container(
                      ...
                      child: Text(
                        "mnlkgtf kmnl;bj bpis; lkjnvi;olds  ",
                        style: TextStyle(
                            fontSize: 15,
                            color: Theme.of(context).secondaryHeaderColor),
                ...
                children: [
                  GestureDetector(
                    onLongPress: () {
                      Clipboard.setData(ClipboardData(
                          text:
                              "mnlkgtf kmnl;bj bpis; lkjnvi;olds lm;vo niopnjo'ev qepfmnp mnprmfp  piomprofm mpormpo"));
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text("Text copied"),
                      ));
                    },
